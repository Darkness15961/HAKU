...
class MisLugaresPublicadosPagina extends StatefulWidget {
  ...
  @override
  State<MisLugaresPublicadosPagina> createState() => _MisLugaresPublicadosPaginaState();
}

class _MisLugaresPublicadosPaginaState extends State<MisLugaresPublicadosPagina> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
                              ...
                              child: Row(
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    tooltip: 'Ver Reseñas',
                                    onPressed: () {
                                      context.push('/inicio/comentarios', extra: lugar);
                                    },
                                  ),
                                  IconButton(
